...
public class test {
	...
	public test() {
		...
		table.setPreferredScrollableViewportSize(table.getPreferredSize());// thanks mKorbel +1
																			// http://stackoverflow.com/questions/10551995/how-to-set-jscrollpane-layout-to-be-the-same-as-jtable

		table.getColumnModel().getColumn(0).setPreferredWidth(300);// so buttons will fit and not be shown butto..
