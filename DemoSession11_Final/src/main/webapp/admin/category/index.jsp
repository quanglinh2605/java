                    ...
                    <c:forEach var="item" items="${ categories }">
                    	<tr>
                          ...
                          <a class="btn btn-info btn-sm"
									href="${ pageContext.request.contextPath }/admin/category?action=update&id=${ item.id }">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Edit
                          </a>
                          <a class="btn btn-danger btn-sm"
									href="${ pageContext.request.contextPath }/admin/category?action=delete&id=${item.id}">
